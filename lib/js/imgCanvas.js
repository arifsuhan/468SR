...
class imgTensor 
{
  ...
  sharpen(matrix)
  {
    ...
    var r,g,b,a;
    r = conv2dTensor(matrix[0],[3,3],[0], 1, filter, [0]);
    g = conv2dTensor(matrix[1],[3,3],[0], 1, filter, [0]);
    b = conv2dTensor(matrix[2],[3,3],[0], 1, filter, [0]);
    a = conv2dTensor(matrix[3],[3,3],[0], 1, filter, [0]);
    ...
    this.context.putImageData(imgData, this.canvas.width/2+20, 0);
    //this.redraw(temp);    
  }
